...
export const ALIMENTOS: Alimento[] = [
  // ── PROTEINAS (15) ─────────────────────────────────────────
  { id: 'frango-peito-grelhado', nome: 'Peito de frango grelhado', kcal: 159, p: 32, c: 0, g: 2.5, categoria: 'proteina', unidadeRef: '---' },
  { id: 'frango-coxa-assada', nome: 'Coxa de frango assada', kcal: 215, p: 26, c: 0, g: 12, categoria: 'proteina', unidadeRef: '---' },
  { id: 'patinho-moido', nome: 'Patinho moido refogado', kcal: 219, p: 26.4, c: 0, g: 12.2, categoria: 'proteina', unidadeRef: '---' },
  ...
  { id: 'sardinha-lata', nome: 'Sardinha em lata', kcal: 152, p: 22, c: 0, g: 7, categoria: 'proteina', unidadeRef: '1 lata = 130g' },
  { id: 'tilapia-grelhada', nome: 'Tilapia grelhada', kcal: 128, p: 26, c: 0, g: 2.7, categoria: 'proteina', unidadeRef: '---' },
  { id: 'salmao-grelhado', nome: 'Salmao grelhado', kcal: 208, p: 20, c: 0, g: 13, categoria: 'proteina', unidadeRef: '---' },
  { id: 'figado-bovino', nome: 'Figado bovino grelhado', kcal: 225, p: 29.1, c: 4.3, g: 9.5, categoria: 'proteina', unidadeRef: '---' },
  { id: 'peru-fatiado', nome: 'Peito de peru fatiado', kcal: 110, p: 18, c: 2, g: 3, categoria: 'proteina', unidadeRef: '1 fatia = 15g' },
  ...
  { id: 'macarrao-cozido', nome: 'Macarrao cozido', kcal: 102, p: 3.4, c: 19.9, g: 1.2, categoria: 'carboidrato', unidadeRef: '---' },
  ...
  { id: 'maca', nome: 'Maca', kcal: 56, p: 0.3, c: 15.2, g: 0, categoria: 'carboidrato', unidadeRef: '1 un = 150g' },
  ...
  { id: 'tapioca-goma', nome: 'Tapioca (goma hidratada)', kcal: 68, p: 0, c: 17.1, g: 0, categoria: 'carboidrato', unidadeRef: '---' },
  ...
  { id: 'castanha-para', nome: 'Castanha do Para', kcal: 643, p: 14.5, c: 3.4, g: 63.5, categoria: 'gordura', unidadeRef: '1 un = 4g' },
  { id: 'pasta-amendoim', nome: 'Pasta de amendoim', kcal: 593, p: 25, c: 12, g: 50, categoria: 'gordura', unidadeRef: '1 cs = 15g' },
  { id: 'manteiga', nome: 'Manteiga', kcal: 726, p: 0.4, c: 0, g: 82, categoria: 'gordura', unidadeRef: '1 cs = 12g' },
  { id: 'coco-ralado', nome: 'Coco ralado', kcal: 403, p: 4.5, c: 10, g: 39, categoria: 'gordura', unidadeRef: '---' },
  ...
  { id: 'iogurte-desnatado', nome: 'Iogurte natural desnatado', kcal: 42, p: 4, c: 5.4, g: 0.3, categoria: 'laticinio', unidadeRef: '---' },
  { id: 'iogurte-grego', nome: 'Iogurte grego natural', kcal: 90, p: 5, c: 8, g: 4, categoria: 'laticinio', unidadeRef: '---' },
