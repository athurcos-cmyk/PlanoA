...
export const DIETA_PLANTAO: TipoDia = {
  ...
  slots: [
      ...
      opcoes: [
        ...
        },
        {
          ...
          itens: [
            ...
            { id: 'leite-integral', nome: 'Leite integral', gramasPlano: 250, unidade: 'ml', macrosPor100g: { kcal: 60, p: 3, c: 4.5, g: 3.2 } },
            { id: 'banana', nome: 'Banana', gramasPlano: 100, unidade: 'un', unidadeNome: 'banana', macrosPor100g: { kcal: 92, p: 1.4, c: 23.8, g: 0.1 } },
          ],
        },
        {
          id: 'cafe-plantao-cuscuz-queijo',
          nome: 'Cuscuz com ovos, peru e banana',
          categoria: 'cafe',
          itens: [
    ...
    },
    {
      ...
      nome: 'Almoço',
      horario: '12:30',
      macrosAlvo: { kcal: 640, p: 57, c: 78, g: 9 },
      opcoes: [
        {
          ...
          itens: [
            ...
            { id: 'frango-grelhado', nome: 'Peito de frango grelhado', gramasPlano: 160, unidade: 'g', macrosPor100g: { kcal: 159, p: 30, c: 0, g: 2.5 } },
        ...
        },
        {
          ...
          nome: 'Batata doce com frango e feijão',
          categoria: 'prato-principal',
          itens: [
            { id: 'batata-doce', nome: 'Batata doce cozida', gramasPlano: 350, unidade: 'g', macrosPor100g: { kcal: 77, p: 0.6, c: 18.4, g: 0.1 } },
            { id: 'frango-grelhado', nome: 'Peito de frango grelhado', gramasPlano: 170, unidade: 'g', macrosPor100g: { kcal: 159, p: 30, c: 0, g: 2.5 } },
            { id: 'feijao-cozido', nome: 'Feijão cozido', gramasPlano: 80, unidade: 'g', macrosPor100g: { kcal: 76, p: 4.8, c: 13.6, g: 0.5 } },
        ...
        },
        {
          ...
          nome: 'Arroz, feijão, frango e sardinha',
          categoria: 'prato-principal',
          itens: [
            { id: 'arroz-branco', nome: 'Arroz branco cozido', gramasPlano: 210, unidade: 'g', macrosPor100g: { kcal: 128, p: 2.5, c: 28.1, g: 0.2 } },
            { id: 'feijao-cozido', nome: 'Feijão cozido', gramasPlano: 80, unidade: 'g', macrosPor100g: { kcal: 76, p: 4.8, c: 13.6, g: 0.5 } },
            { id: 'frango-grelhado', nome: 'Peito de frango grelhado', gramasPlano: 100, unidade: 'g', macrosPor100g: { kcal: 159, p: 30, c: 0, g: 2.5 } },
            { id: 'sardinha-lata', nome: 'Sardinha em lata', gramasPlano: 80, unidade: 'g', macrosPor100g: { kcal: 165, p: 21.5, c: 2, g: 7.8 } },
            { id: 'salada-crua', nome: 'Salada (alface, tomate, pepino)', gramasPlano: 150, unidade: 'g', macrosPor100g: { kcal: 15, p: 0.8, c: 2.7, g: 0.1 } },
          ],
        },
        {
          id: 'almoco-plantao-ovo-atum',
    ...
    },
    {
      ...
      opcoes: [
        ...
        },
        {
          ...
          itens: [
            { id: 'whey-po', nome: 'Whey protein (pó)', gramasPlano: 20, unidade: 'g', macrosPor100g: { kcal: 400, p: 80, c: 10, g: 5 } },
            { id: 'leite-integral', nome: 'Leite integral', gramasPlano: 100, unidade: 'ml', macrosPor100g: { kcal: 60, p: 3, c: 4.5, g: 3.2 } },
            { id: 'pao-frances', nome: 'Pão francês', gramasPlano: 40, unidade: 'un', unidadeNome: 'pão', macrosPor100g: { kcal: 300, p: 8, c: 58.6, g: 3.1 } },
            { id: 'banana', nome: 'Banana', gramasPlano: 50, unidade: 'un', unidadeNome: 'banana', macrosPor100g: { kcal: 92, p: 1.4, c: 23.8, g: 0.1 } },
            { id: 'pacoca', nome: 'Paçoca', gramasPlano: 10, unidade: 'un', unidadeNome: 'paçoca', macrosPor100g: { kcal: 475, p: 16.1, c: 48.7, g: 25.3 } },
          ],
        },
      ],
    },
    {
      ...
      horario: '21:00',
      macrosAlvo: { kcal: 615, p: 52, c: 70, g: 12 },
      opcoes: [
        {
        ...
        },
        {
          ...
          categoria: 'prato-principal',
          itens: [
            { id: 'macarrao-cozido', nome: 'Macarrão cozido', gramasPlano: 200, unidade: 'g', macrosPor100g: { kcal: 144, p: 5, c: 29.4, g: 0.5 } },
            { id: 'carne-moida-patinho', nome: 'Carne moída patinho', gramasPlano: 130, unidade: 'g', macrosPor100g: { kcal: 212, p: 26.7, c: 0, g: 11.2 } },
