  ...
  slots: [
    {
      ...
      opcoes: [
        ...
        },
        {
          ...
          categoria: 'cafe',
          itens: [
            { id: 'cuscuz-cozido', nome: 'Cuscuz cozido', gramasPlano: 180, unidade: 'g', macrosPor100g: { kcal: 112, p: 2.6, c: 25.1, g: 0.4 } },
            { id: 'ovo-inteiro', nome: 'Ovo inteiro', gramasPlano: 150, unidade: 'un', unidadeNome: 'ovo', macrosPor100g: { kcal: 146, p: 13.3, c: 0.6, g: 9.5 } },
            { id: 'banana', nome: 'Banana', gramasPlano: 100, unidade: 'un', unidadeNome: 'banana', macrosPor100g: { kcal: 92, p: 1.4, c: 23.8, g: 0.1 } },
          ],
        },
    ...
    },
    {
      ...
      opcoes: [
        ...
        },
        {
          ...
          nome: 'Shaker com whey, banana, paçoca e ovos',
          categoria: 'shake',
          itens: [
            { id: 'whey-po', nome: 'Whey protein (pó)', gramasPlano: 30, unidade: 'g', macrosPor100g: { kcal: 400, p: 80, c: 10, g: 5 } },
            { id: 'banana', nome: 'Banana', gramasPlano: 100, unidade: 'un', unidadeNome: 'banana', macrosPor100g: { kcal: 92, p: 1.4, c: 23.8, g: 0.1 } },
            { id: 'pacoca', nome: 'Paçoca', gramasPlano: 20, unidade: 'un', unidadeNome: 'paçoca', macrosPor100g: { kcal: 486, p: 13, c: 53, g: 24 } },
            { id: 'ovo-inteiro', nome: 'Ovo inteiro', gramasPlano: 100, unidade: 'un', unidadeNome: 'ovo', macrosPor100g: { kcal: 146, p: 13.3, c: 0.6, g: 9.5 } },
          ],
        },
      ],
      ...
      opcoes: [
        {
          ...
          itens: [
            { id: 'arroz-branco', nome: 'Arroz branco cozido', gramasPlano: 220, unidade: 'g', macrosPor100g: { kcal: 128, p: 2.5, c: 28.2, g: 0.2 } },
            { id: 'feijao-cozido', nome: 'Feijão cozido', gramasPlano: 80, unidade: 'g', macrosPor100g: { kcal: 77, p: 4.8, c: 13.6, g: 0.5 } },
      ...
      opcoes: [
        ...
        },
        {
          ...
          itens: [
            ...
            { id: 'pacoca', nome: 'Paçoca', gramasPlano: 15, unidade: 'un', unidadeNome: 'paçoca', macrosPor100g: { kcal: 486, p: 13, c: 53, g: 24 } },
          ],
        },
      ],
    },
    {
      ...
      opcoes: [
        ...
        },
        {
          ...
          itens: [
            { id: 'ovo-inteiro', nome: 'Ovo inteiro', gramasPlano: 150, unidade: 'un', unidadeNome: 'ovo', macrosPor100g: { kcal: 146, p: 13.3, c: 0.6, g: 9.5 } },
            { id: 'frango-desfiado', nome: 'Frango desfiado', gramasPlano: 150, unidade: 'g', macrosPor100g: { kcal: 159, p: 32, c: 0, g: 3.2 } },
            { id: 'arroz-branco', nome: 'Arroz branco cozido', gramasPlano: 150, unidade: 'g', macrosPor100g: { kcal: 128, p: 2.5, c: 28.2, g: 0.2 } },
            { id: 'legumes-cozidos', nome: 'Legumes cozidos (abobrinha, cenoura, chuchu)', gramasPlano: 200, unidade: 'g', macrosPor100g: { kcal: 24, p: 0.9, c: 4.8, g: 0.2 } },
          ],
        },
        {
          ...
          itens: [
            ...
            { id: 'carne-moida-patinho', nome: 'Carne moída patinho', gramasPlano: 160, unidade: 'g', macrosPor100g: { kcal: 170, p: 26, c: 0, g: 7 } },
      ...
      opcoes: [
        ...
        },
        {
          ...
          itens: [
            ...
            { id: 'leite-po-desnatado', nome: 'Leite em pó desnatado', gramasPlano: 15, unidade: 'g', macrosPor100g: { kcal: 355, p: 36, c: 52, g: 0.9 } },
