    ...
    },
    {
      ...
      exercicios: [
        ...
        },
        {
          ...
          tutorial: {
            objetivo: 'Dar um estimulo de puxada vertical para latissimo e parte alta das costas.',
            execucao: [
              'Prenda o elastico em um ponto alto e seguro.',
              'Fique com peito aberto e bracos estendidos para cima.',
              'Puxe para a parte alta do peito pensando em descer os cotovelos.',
              'Volte devagar ate alongar bem sem perder postura.',
            ],
            sentir: [
              'Regiao lateral das costas e area abaixo da axila.',
              'Parte alta das costas ajudando a fechar o movimento.',
            ],
            erros: [
              'Dobrar demais o cotovelo e transformar em exercicio de biceps.',
              'Encolher o ombro na subida e perder tensao nas costas.',
              'Usar amplitude curta demais.',
            ],
            adaptacoes: [
              'Se nao tiver ancoragem alta, sente no chao e faca remada com elastico preso nos pes.',
              'Se o elastico estiver leve, aumente a distancia ou use mais pausa no final.',
            ],
          },
          descansoSegundos: 75,
        },
