...
## 09:30 — Lanche da Manhã (no hospital)
**Alvo:** ~360 kcal | 25g P | 45g C | 10g F

### Opção 1 — Iogurte com ovo e banana
- 200g iogurte natural desnatado (pote individual)
- 15g aveia
- 1 banana
- 2 ovos cozidos (leva prontos de casa)

> Tudo cabe num saquinho. Ovo cozido aguenta 4-5h fora da geladeira sem problema.

**Macros:** ~365 kcal | 25g P | 46g C | 11g F
...
### Opção 3 — Shake com ovo e paçoca
- 1 scoop whey FTW no shaker (leva em pó, mistura na hora com água)
- 2 ovos cozidos
- 1 banana
- 1 paçoca

> **Mudança:** removido o atum (não é prático pro hospital). Trocado por combo de shaker (leva o pó, mistura com água na copa) + ovos cozidos + fruta.

**Macros:** ~450 kcal | 37g P | 37g C | 17g F
...
## 19:00 — Lanche de Recuperação (fim do turno / voltando pra casa)
**Alvo:** ~210 kcal | 15g P | 25g C | 5g F

### Opção 1 — Banana com paçoca e shake
- 1 banana
- 1 paçoca
- 1 scoop whey FTW (shaker na bolsa)

**Macros:** ~300 kcal | 27g P | 36g C | 7g F

---

### Opção 2 — Iogurte com banana e aveia
- 200g iogurte natural desnatado
- 1 banana
- 15g aveia

**Macros:** ~225 kcal | 11g P | 45g C | 1g F

---

### Opção 3 — Mini Sanduíche
- 1/2 pão francês
- 3 fatias peito de peru
- 1 maçã

**Macros:** ~170 kcal | 13g P | 32g C | 2g F

> 💡 Esse lanche substitui o antigo "pré-treino" das 18h. Plantão drena — isso ajuda a não chegar em casa desesperado de fome e atacar a geladeira.
...
## Totais do dia (estimado, combinando opções 1 de cada)

| Macro | Valor | Alvo | Status |
|-------|-------|------|--------|
| Calorias | ~2.590 kcal | 2.600 | ✅ |
| Proteína | ~198g | 195-205 | ✅ |
| Carboidrato | ~300g | 290-310 | ✅ |
| Gordura | ~61g | 70-80 | ⚠️ Um pouco abaixo |
| Fibra | ~28g | 30-35 | ⚠️ Um pouco abaixo |

> **Nota:** a versão "Opção 1 em tudo" fica mais leve em gordura porque prioriza shakes e frango magro. Se quiser bater exatamente 75g de gordura, usa 1 colher (sopa) de azeite no almoço OU jantar em vez de 1 colher chá. Fica fácil equilibrar.

## Notas específicas do plantão
- **Hidratação:** ainda mais crítica. Plantão + AC seca = desidratação rápida. Leva garrafa de 1,5-2L, bate 2x.
- **Evitar:** refrigerante, suco industrializado, salgadinho da cantina, fast food da rua. Uma refeição besta pode arrebentar o déficit do dia.
- **Embutidos:** peito de peru/presunto magro são OK (20-30g de sódio por fatia), não abuse — máximo 4-5 fatias/dia.
- **Sono pós-plantão:** você dorme mais nesse dia (8-9h). Aproveitar pra recuperação.
- **Preparo:** tudo que é marmita/lanche deve ser montado **no dia anterior**. Isso é o que separa plano de papel de plano executável.
